...
:: Fonts
@REM %PICTCONV% -f0 -d0 -o2 assets\Font6x8.png build\files\Font6x8.hir

:: Pictures
@REM %PICTCONV% -f1 -d0 -o2 data\FirstProgram.png build\files\FirstProgram.hir
@REM %PICTCONV% -f1 -d0 -o2 data\SecondProgram.png build\files\SecondProgram.hir
...
%osdk%\bin\xa -DASSEMBLER=XA loader\sector_1-jasmin.asm -o ..\build\files\sector_1-jasmin.o
IF ERRORLEVEL 1 GOTO Error
%osdk%\bin\xa -DASSEMBLER=XA loader\sector_2-microdisc.asm -o ..\build\files\sector_2-microdisc.o
IF ERRORLEVEL 1 GOTO Error
%osdk%\bin\xa -DASSEMBLER=XA loader\sector_3.asm -o ..\build\files\sector_3.o
IF ERRORLEVEL 1 GOTO Error

ECHO.
ECHO Assembling loader
%osdk%\bin\xa -DASSEMBLER=XA loader\loader.asm -o ..\build\files\loader.o
IF ERRORLEVEL 1 GOTO Error
...
SET OSDKLINK=
SET OSDKADDR=$400
SET OSDKNAME=wolfric
SET OSDKFILE=main allasm allc overlay 
SET OSDKDISK=
CALL %OSDK%\bin\make.bat %OSDKFILE%
copy build\final.out ..\build\files\wolfric.o
copy build\symbols ..\build\symbols_wolfric
